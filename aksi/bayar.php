...
if ($_POST) {
    if ($_POST['aksi'] == 'tambah') { //untuk manajemen
        ...
        $sql_cari_id_bayar="SELECT id_bayar FROM bayar WHERE id_siswa=$id_siswa ORDER BY id_bayar DESC LIMIT 1"; // 1= TERAKHIR KALI DI INPUT
...
if ($_GET) {
    if ($_GET['aksi'] == 'hapus') {
        ...
        // $sql="DELETE FROM bayar$id_bayar WHERE id_bayar$id_bayar=$id_bayar"; //Hard delete

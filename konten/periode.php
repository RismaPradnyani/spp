                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="aksi/periode.php" method="post">
                      ...
                      <input type="date" name="tanggal_akhir" value="<?= $kolom['tanggal_akhir']; ?>" class="form-control" required="required">
                      <br>
          ...
          ?>
            <tr>
              ...
              <td>
                ...
                &nbsp;
                <a onclick="return confirm('Yakin akan menghapus data ini secara permanen?')" href="aksi/periode.php?aksi=hapus-permanen&id_periode=<?= $kolom['id_periode']; ?>">

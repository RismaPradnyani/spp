<?php
// untuk menampilkan siapa yang login
        ...
        <div class="container-fluid">
          ...
          ?>
                        <tr class="<?= $warna; ?>">
                            ...
                            <td>
                                <a
                                    title="Informasi Detail Tagihan"
                                    href="index.php?p=tagihan-info-siswa&id_tagihan=<?= $kolom['id_tagihan']; ?>">
                                    <i class="fas fa-search" style="color: purple;"></i>
                                </a>
                            </td>
                        </tr>
          ...
          ?>
                        <tr>
                            ...
                            <?php 
                                ...
                                ?>
                                <span class="<?= $class; ?>"><?= $kolom['status_verifikasi']; ?></span>
                            </td>
                            <!-- tombol pembayaran -->
                            <td>
                                <a
                                    title="Informasi Detail Pembayaran"

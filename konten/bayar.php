    ...
    <section class="content">
        <div class="container-fluid">
          ...
          ?>
                ...
                ?>
                            <span class="<?= $class; ?>"><?= $kolom['status_verifikasi']; ?></span></td>

                        <td>
                            <!-- Info Alokasi -->
                            <a href="index.php?p=bayar-alokasi&id_bayar=<?= $kolom['id_bayar']; ?>" title="Informasi Alokasi Pembayaran"><i class="fas fa-search" style="color: purple;"></i></a>
                          <!-- tombol konfirmasi -->
                          <?php 
                          if($kolom['status_verifikasi']=='Belum Verifikasi'){ ?>
                            <a
                         ...
                         <?php } ?>
                            ...
                            <a
                                ...
                                <i class="fas fa-trash" style="color: purple;"></i>
                            </a> -->
                        </td>
                    </tr>

        ...
        <table id="example1" class="table table-hover">
          ...
          ?>
            <tr>
              ...
              <td>
                <!-- tombol edit -->
                <a href="#" data-toggle="modal" data-target="#modalUbah<?= $kolom['id_biaya']; ?>">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="aksi/biaya.php" method="post">
          ...
          <label for="deskripsi_biaya">Deskripsi Biaya</label>
          <input type="text" name="deskripsi_biaya" class="form-control" required="required">

          <label for="jumlah_biaya" class="mt-3">Jumlah Biaya</label>
          <input type="number" name="jumlah_biaya" class="form-control" required="required">
          <br>
          <label for="tanggal_jatuh_tempo">Tanggal Jatuh Tempo</label>
          ...
          ?>
            <tr>
              ...
              <td>
                ...
                &nbsp;
                <a onclick="return confirm('Yakin akan menghapus data ini secara permanen?')" href="aksi/biaya.php?aksi=hapus-permanen&id_biaya=<?= $kolom['id_biaya']; ?>">

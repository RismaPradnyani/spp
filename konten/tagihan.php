        ...
        <table id="example1" class="table table-hover table-sm">
          ...
          ?>
            <tr>
              ...
              <td>
                <!-- tombol informasi -->
                <a title="Informasi Riwayat Tagihan" href="index.php?p=tagihan-info&id_tagihan=<?= $kolom['id_tagihan']; ?>"><i class="fas fa-search" style="color: purple;"></i></a>

                &nbsp;
                <!-- Tombol edit -->
                <a title="Ubah Tagihan" href="index.php?p=tagihan-edit&id_tagihan=<?= $kolom['id_tagihan']; ?>">
                  <i class="fas fa-edit" style="color: purple;"></i></a>
              </td>
            </tr>
